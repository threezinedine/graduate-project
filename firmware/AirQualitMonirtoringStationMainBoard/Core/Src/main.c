...
/* USER CODE BEGIN PV */
uint8_t u8RxData = 0;
Communication_Instance *sGeometry;
uint8_t u8DataIndex = 0;
char chStationId[ID_LENGTH] = "504e6df9-dc91-4557-8059-8caf386825cc";
uint32_t u32UpdateTime = 25;
...
int main(void)
{
  ...
  while (1)
  {
	  Command_Update();
	  MainProcess();
//	  Communication_Update(sGeometry);
