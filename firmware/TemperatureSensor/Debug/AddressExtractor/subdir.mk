...
C_SRCS += \
../AddressExtractor/AddreessExtractor.c 

OBJS += \
./AddressExtractor/AddreessExtractor.o 

C_DEPS += \
./AddressExtractor/AddreessExtractor.d 


# Each subdirectory must supply rules for building sources it contributes
AddressExtractor/%.o AddressExtractor/%.su AddressExtractor/%.cyclo: ../AddressExtractor/%.c AddressExtractor/subdir.mk
...
clean: clean-AddressExtractor

clean-AddressExtractor:
	-$(RM) ./AddressExtractor/AddreessExtractor.cyclo ./AddressExtractor/AddreessExtractor.d ./AddressExtractor/AddreessExtractor.o ./AddressExtractor/AddreessExtractor.su

.PHONY: clean-AddressExtractor
